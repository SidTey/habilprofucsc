...
import SelectInput from '@/Components/SelectInput'; // <-- Importa el nuevo componente
...
export default function Edit({ auth, habilitacion, profesores, roles_actuales }) {
    ...
    const PrTutFields = () => (
        <div className="p-4 mt-4 border rounded-lg">
            {/* ... (Aquí va el código para PrTut, que ya usa SelectInput para el tutor) ... */}
                        ...
                        <form onSubmit={submit}>  
                            ...
                            {Object.keys(errors).length > 0 && (
                                <div className="mb-4 p-4 bg-red-100 border border-red-400 text-red-700 rounded">
                                    ...
                                    <ul className="list-disc list-inside">
                                        {/* Mapea y muestra CADA error de validación */}
                            ...
                            <div className="mt-4">
                                ...
                                <textarea
                                    ...
                                    rows="5"
                                ></textarea>
                                <InputError message={errors.descripcion_habilitacion} className="mt-2" />
                            </div>
                            ...
                            {(data.tipo_habilitacion === 'PrIng' || data.tipo_habilitacion === 'PrInv') && <PrIngPrInvFields />}
                            
                            {data.tipo_habilitacion === 'PrTut' && <PrTutFields />}

                            {/* --- DATOS OPCIONALES (NOTA) --- */}
                            <h3 className="text-lg font-medium mt-6">Nota y Fecha</h3>
                            <div className="mt-4 grid grid-cols-2 gap-4">
                                <div>
                                ...
                                <div>
                                    <InputLabel htmlFor="fecha_nota" value="Fecha (DD/MM/AAAA)" />
